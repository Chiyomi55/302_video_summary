...
assert(
  env('NEXT_PUBLIC_UPLOAD_API_URL'),
  'NEXT_PUBLIC_UPLOAD_API_URL is required'
)
assert(env('NEXT_PUBLIC_SHARE_PATH'), 'NEXT_PUBLIC_SHARE_PATH is required')
assert(
  env('NEXT_PUBLIC_DEFAULT_SHARE_DIR'),
  'NEXT_PUBLIC_DEFAULT_SHARE_DIR is required'
)
